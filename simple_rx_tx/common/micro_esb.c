...
void uesb_event_handler_rx(void)
{
...
void uesb_setup_rx(void){
    ...
    uint8_t rx_addr_p0[] = {0x12, 0x34, 0x56, 0x78, 0x23};
    uint8_t rx_addr_p1[] = {0xBA, 0xDE, 0xF0, 0x12, 0x9a};
    uint8_t rx_addr_p2   = 0x65;
    ...
    uesb_config.event_handler       = uesb_event_handler_rx;
...
void uesb_setup_tx(uesb_payload_t *tx_payload){
    ...
    //uesb_config.protocol            = UESB_PROTOCOL_ESB_DPL;
    uesb_config.bitrate             = UESB_BITRATE_2MBPS;
    uesb_config.event_handler       = uesb_event_handler_tx;
